...
namespace AR.Expressions
{
	...
	{
		public static readonly Function Sqrt = new PredefinedFunction("Sqrt", Math.Sqrt);
		
		public static readonly Function Exp = new PredefinedFunction("Exp", Math.Exp);
		public static readonly Function Log = new PredefinedFunction("Log", (a, b) => Math.Log(a, b));
		public static readonly Function Ln = new PredefinedFunction("Ln", a => Math.Log(a));

		public static readonly Function Sin = new PredefinedFunction("Sin", Math.Sin);
		public static readonly Function Cos = new PredefinedFunction("Cos", Math.Cos);
		public static readonly Function Tan = new PredefinedFunction("Tan", Math.Tan);
		...
		public static readonly Function Arcsin = new PredefinedFunction("Arcsin", Math.Asin);
		public static readonly Function Arccos = new PredefinedFunction("Arccos", Math.Acos);
		public static readonly Function Arctan = new PredefinedFunction("Arctan", Math.Atan);
